 ...
 */
add_filter( 'template_include', array( 'Gadnews_Wrapping', 'wrap' ), 99 );
add_filter( 'gadnews_wrap_base', 'gadnews_wrap_base_cpts' );
 ...
 */
function gadnews_template_path() {
	return Gadnews_Wrapping::$main_template;
}
 ...
 */
function gadnews_template_base() {
	return Gadnews_Wrapping::$base;
}

if ( ! class_exists( 'Gadnews_Wrapping' ) ) {
	...
	class Gadnews_Wrapping {
		...
		/**
		 * Initialize new instance of Gadnews_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'gadnews_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Gadnews_Wrapping class.
		 *
		 * @since 4.0.0
 ...
 */
function gadnews_wrap_base_cpts( $templates ) {
